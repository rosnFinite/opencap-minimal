import sys
sys.path.append("mmpose_utils") # utilities in child directory
import cv2 
import numpy as np 
import pandas as pd
import os 
...
def synchronizeVideoKeypoints(keypointList, confidenceList,
    ...
    visualize2Dkeypoint = False # this is a visualizations just for testing what filtered input data looks like
...
def triangulateMultiviewVideo(CameraParamDict,keypointDict,imageScaleFactor=1,
    ...
    if CameraDirectories != None and trialName !=None:       
        ...
        print(f"\nVideo frames used for multiview video [start, end]: [{startInd}, {endInd}]")
        print("necessary to synchronize with results of different models. HAS TO BE DONE MANUAL, store the frames indices\n")
